...
Deno.serve(async (req: Request) => {
  try {
    ...
    if (topic === 'payment') {
      // Pagamento avulso de uma cobrança recorrente — útil para registrar histórico/recibos.
      ...
      if (mpRes.ok) {
        ...
        // Aqui você pode gravar em uma tabela `pagamentos_assinatura` para histórico/nota.
      }
    }
